...
void *detect_in_thread(void *ptr)
{
    ...
    crop_detections(det, l.w*l.h*l.n, demo_thresh, boxes, probs, demo_names, demo_classes, adALPR, demo_alphabet);
...
{
	adALPR = openalpr_init("adwide", "/usr/share/openalpr/config/openalpr.defaults.conf", "/usr/share/openalpr/runtime_data/");
	dxbALPR = openalpr_init("eu", "/usr/share/openalpr/config/openalpr.defaults.conf", "/usr/share/openalpr/runtime_data/");
	openalpr_set_default_region(adALPR, "ad");
	//openalpr_set
